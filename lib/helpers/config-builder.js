...
var Builder = function(params) {
  ...
  var localizationService = params.localizationService;
  ...
  var configSource = fs.readFileSync(templateFile, 'utf8');
  var configTemplate = ejs.compile(configSource);
  ...
  lodash.assign(configDataModel, lodash.pick(localizationService.i18n(), ['__', '__n', '__mf']));
